...
​
const misteryEnvelope = (randomSelector(charactersArray.suspects.first_name) + randomSelector(charactersArray.suspects.last_name) + " killed Mr. Boddy using the " + randomSelector(weaponsArray.weapons) + " in the " + randomSelector(roomArray.rooms));
​
